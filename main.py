...
async def init_db():
    async with aiosqlite.connect(DB) as db:
        ...
        CREATE TABLE IF NOT EXISTS jobs (
            ...
            title TEXT NOT NULL, company TEXT DEFAULT 'Unknown',
            location TEXT DEFAULT 'South Africa', province TEXT,
            is_remote INTEGER DEFAULT 0, category TEXT,
            job_type TEXT DEFAULT 'full-time', salary_min REAL, salary_max REAL,
            salary TEXT, description TEXT, url TEXT UNIQUE NOT NULL,
            source TEXT DEFAULT 'Adzuna', source_job_id TEXT,
            fingerprint TEXT UNIQUE, is_active INTEGER DEFAULT 1,
            is_featured INTEGER DEFAULT 0, posted_at TEXT,
        ...
        CREATE TABLE IF NOT EXISTS applications (
            ...
            job_title TEXT, company TEXT, status TEXT DEFAULT 'applied',
            notes TEXT, applied_at TEXT DEFAULT (datetime('now')),
